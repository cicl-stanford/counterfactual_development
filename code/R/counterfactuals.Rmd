...
# preds = posterior_predict(fit.brm2, newdata = df.exp1_age_grid, re_formula = NA)

df.exp1.age.min = as_tibble(t(preds)) %>%
  # mutate(age = newdat$age) %>%
...
ggplot(df.exp1.age.min, aes(x = age, y = mean)) +
  ...
  geom_vline(xintercept = cross_age, linetype = "dotted", color = "darkgreen") +
  ...
  labs(x = "Age", y = "Predicted Probability",
       title = "Predicted Performance vs Age",
