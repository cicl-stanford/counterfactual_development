...
# Overall adults will thank the individual who prevented the worse outcome from 
# occurring at rates that exceed chance
...
```{r fig.height=13, fig.width=21.5, message=FALSE, warning=FALSE}
