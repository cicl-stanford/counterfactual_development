...
preds = posterior_epred(fit.brm2, newdata = df.exp1_age_grid, re_formula = NA)
...
ggplot(df.exp1.age.min, aes(x = age, y = mean)) +
...
# Get posterior draws of predicted probabilities
preds = posterior_epred(fit.brm4, newdata = df.exp2_age_grid, re_formula = NA)
...
ggplot(df.exp2.age.min, aes(x = age, y = mean)) +
  geom_ribbon(aes(ymin = lower, ymax = upper), 
              alpha = 0.2, fill = "darkgreen") +
  geom_line(color = "darkgreen", size = 1) +
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "red") +
